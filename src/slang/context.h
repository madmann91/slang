...
public:
    ...
    /// Registers a binary function with two arguments of the same type in the environment.
    void register_binary(const std::string& name, GenTypeFn f);
    /// Registers a binary function with two arguments of different types in the environment.
    ...
    /// Calls the given function with a primitive type.
    static GenTypeFn prim_type(ast::PrimType::Prim prim);
    ...
    void register_mod() {
        register_binary("mod", gentype, prim_type(ast::PrimType::PRIM_FLOAT));
        register_binary("mod", gentype);
        register_binary("mod", gendtype, prim_type(ast::PrimType::PRIM_DOUBLE));
        register_binary("mod", gendtype);
    }
