...
#define SLANG_KEY_DATA(key, str, type, rows, cols) SLANG_KEY(key, str)
#endif

SLANG_KEY_DATA(BVEC4, "bvec4", BOOL, 4, 1)
SLANG_KEY_DATA(BVEC3, "bvec3", BOOL, 3, 1)
SLANG_KEY_DATA(BVEC2, "bvec2", BOOL, 2, 1)
SLANG_KEY_DATA(BOOL,  "bool",  BOOL, 1, 1)

SLANG_KEY_DATA(IVEC4, "ivec4", INT, 4, 1)
SLANG_KEY_DATA(IVEC3, "ivec3", INT, 3, 1)
SLANG_KEY_DATA(IVEC2, "ivec2", INT, 2, 1)
SLANG_KEY_DATA(INT,   "int",   INT, 1, 1)

SLANG_KEY_DATA(UVEC4, "uvec4", UINT, 4, 1)
SLANG_KEY_DATA(UVEC3, "uvec3", UINT, 3, 1)
SLANG_KEY_DATA(UVEC2, "uvec2", UINT, 2, 1)
SLANG_KEY_DATA(UINT,  "uint",  UINT, 1, 1)

SLANG_KEY_DATA(VEC4,  "vec4",  FLOAT, 4, 1)
SLANG_KEY_DATA(VEC3,  "vec3",  FLOAT, 3, 1)
SLANG_KEY_DATA(VEC2,  "vec2",  FLOAT, 2, 1)
SLANG_KEY_DATA(FLOAT, "float", FLOAT, 1, 1)

SLANG_KEY_DATA(DVEC4,  "dvec4",  DOUBLE, 4, 1)
SLANG_KEY_DATA(DVEC3,  "dvec3",  DOUBLE, 3, 1)
SLANG_KEY_DATA(DVEC2,  "dvec2",  DOUBLE, 2, 1)
SLANG_KEY_DATA(DOUBLE, "double", DOUBLE, 1, 1)

SLANG_KEY_DATA(MAT4, "mat4", FLOAT, 4, 4)
SLANG_KEY_DATA(MAT3, "mat3", FLOAT, 3, 3)
SLANG_KEY_DATA(MAT2, "mat2", FLOAT, 2, 2)

SLANG_KEY_DATA(MAT4X4, "mat4x4", FLOAT, 4, 4)
SLANG_KEY_DATA(MAT4X3, "mat4x3", FLOAT, 4, 3)
SLANG_KEY_DATA(MAT4X2, "mat4x2", FLOAT, 4, 2)
SLANG_KEY_DATA(MAT3X4, "mat3x4", FLOAT, 3, 4)
SLANG_KEY_DATA(MAT3X3, "mat3x3", FLOAT, 3, 3)
SLANG_KEY_DATA(MAT3X2, "mat3x2", FLOAT, 3, 2)
SLANG_KEY_DATA(MAT2X4, "mat2x4", FLOAT, 2, 4)
SLANG_KEY_DATA(MAT2X3, "mat2x3", FLOAT, 2, 3)
SLANG_KEY_DATA(MAT2X2, "mat2x2", FLOAT, 2, 2)

SLANG_KEY_DATA(DMAT4, "dmat4", DOUBLE, 4, 4)
SLANG_KEY_DATA(DMAT3, "dmat3", DOUBLE, 3, 3)
SLANG_KEY_DATA(DMAT2, "dmat2", DOUBLE, 2, 2)

SLANG_KEY_DATA(DMAT4X4, "dmat4x4", DOUBLE, 4, 4)
SLANG_KEY_DATA(DMAT4X3, "dmat4x3", DOUBLE, 4, 3)
SLANG_KEY_DATA(DMAT4X2, "dmat4x2", DOUBLE, 4, 2)
SLANG_KEY_DATA(DMAT3X4, "dmat3x4", DOUBLE, 3, 4)
SLANG_KEY_DATA(DMAT3X3, "dmat3x3", DOUBLE, 3, 3)
SLANG_KEY_DATA(DMAT3X2, "dmat3x2", DOUBLE, 3, 2)
SLANG_KEY_DATA(DMAT2X4, "dmat2x4", DOUBLE, 2, 4)
SLANG_KEY_DATA(DMAT2X3, "dmat2x3", DOUBLE, 2, 3)
SLANG_KEY_DATA(DMAT2X2, "dmat2x2", DOUBLE, 2, 2)

// Void data type
#ifndef SLANG_KEY_DATA_VOID
#define SLANG_KEY_DATA_VOID(key, str) SLANG_KEY_DATA(key, str, VOID, 1, 1)
#endif
